        ...
        >
          <div className="carousel-inner" id="carousal">
            ...
            <div className="carousel-item active">
              <img
                src="https://source.unsplash.com/random/600x500/?pizza"
            ...
            <div className="carousel-item">
              <img
                src="https://source.unsplash.com/random/600x500/?burger"
                className="d-block w-100"
                alt="..."
              />
            </div>
            <div className="carousel-item">
              <img
                src="https://source.unsplash.com/random/600x500/?hotdog"
                className="d-block w-100"
                alt="..."
              />
            </div>
