...
function Navbar() {
  ...
  <div className="container-fluid">
    <Link className="navbar-brand fs-1 fst-italic" to="/">Savory Bites</Link>
    ...
    <div className="collapse navbar-collapse" id="navbarNav">
      <ul className="navbar-nav me-auto mb-2">
        ...
        <li className="nav-item">
        <Link className="nav-link active fs-3" aria-current="page" to="/">My Orders
        </Link>
      </li>
        :""}
      ...
      <div>
        ...
        My Cart {" "}
        <Badge pill bg-blue>1</Badge>

      </div>
      <div className='btn bg-white text-black mx-2' onClick={handleLogout}>
        Logout
